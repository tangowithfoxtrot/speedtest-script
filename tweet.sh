...
# Taken from https://github.com/agubelu/bash-send-tweet

#########################################################################

# You can also define these values in another file named .twitterkeys
# by placing it in the same directory.
